...
public class TentScreen extends AbstractContainerScreen<BackPackContainer> {
    ...
    public TentScreen(BackPackContainer backPackContainer, Inventory inventory, Component component) {
